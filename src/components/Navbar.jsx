...
function Navbar() {
  ...
  function handleSearch() {
    searchedCoin =
      searchRef.current.value.trim() || searchRefMobile.current.value.trim();
    setSearchResults(
      searchedCoin
        ? coins.filter(
            (c) =>
  ...
  return (
    <nav
      className={`flex flex-col sm:flex-row justify-center items-center w-screen px-3 py-4 text-grey-800 border-b ${
    ...
    >
      <div className="flex justify-between items-center w-full">
        ...
        <div className="hidden sm:flex justify-between items-center min-w-[35%]">
          ...
          <div className="w-[15rem] relative flex flex-col items-center">
            <form
              className="border border-gray-300 w-full rounded-md overflow-hidden py-1 mx-5"
      ...
      <div className="w-[20rem] relative flex sm:hidden flex-col items-center mt-3 justify-self-center self-center m-auto">
        <form className="border border-gray-300 w-full rounded-md overflow-hidden py-1 mx-5 flex">
          <button type="submit" className="search-submit">
            <i className="fa-solid fa-magnifying-glass text-gray-400 px-2"></i>
          </button>
